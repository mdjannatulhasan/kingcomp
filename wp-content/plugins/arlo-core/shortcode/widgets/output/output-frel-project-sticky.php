...
class frelProjectSticky {
	...
	public function __construct() {
		...
		add_shortcode( 'frenify_project_sticky', array( $this, 'render' ) );
	...
	function render( $args, $content = '') {
		...
		$html .= '<div class="fn_cs_project_sticky"><div class="container"><div class="inner fn_cs_sminiboxes"><div class="left_part fn_cs_sminibox"><div class="fn_cs_sticky_section"><h3>'.$title.'</h3><p>'.$desc.'</p>'.$view_all_link.'</div></div><div class="right_part fn_cs_sminibox"><div class="fn_cs_sticky_section"><ul>';
