...
class frelProjectStickyFull {
	...
	public function __construct() {
		...
		add_shortcode( 'frenify_project_sticky_full', array( $this, 'render' ) );
	...
	function render( $args, $content = '') {
		...
		$post_desc_count 		= $args['post_desc_count'];
		...
		$html .= '<div class="fn_cs_project_sticky_full"><div class="inner fn_cs_sminiboxes"><div class="left_part fn_cs_sminibox"><div class="fn_cs_sticky_section"><h3>'.$title.'</h3><p>'.$desc.'</p>'.$view_all_link.'</div></div><div class="right_part fn_cs_sminibox"><div class="fn_cs_sticky_section"><ul>';
		foreach ( $arlo_post_loop->posts as $fn_post ) {
			...
			$img_holder	= '<div class="img_holder"><img src="'.FREL_PLUGIN_URL.'assets/img/thumb-700-500.jpg" alt="" /><div class="abs_img" data-bg-img="'.$post_image.'"><a href="'.$post_permalink.'"></a></div></div>';
