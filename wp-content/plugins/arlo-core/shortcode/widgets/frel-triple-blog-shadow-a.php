...
class Frel_Triple_Blog_Shadow_A extends Widget_Base {
	...
	protected function render() {
		...
		$html .= '<div class="fn_cs_triple_blog_shadow fn_second"><div class="container"><div class="inner">';
		$has_img 	= '';
		$posts_part	= '<ul>';
		foreach ( $arlo_post_loop->posts as $fn_post ) {
			...
			$img_holder 		= '<div class="img_holder" data-bg-img="'.$post_img.'"><a href="'.$post_permalink.'"></a><img src="'.FREL_PLUGIN_URL.'assets/img/thumb-370-330.jpg" alt="" /></div>';
